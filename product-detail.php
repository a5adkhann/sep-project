...
if (isset($_GET['id'])) {
	...
	while ($fetch_product_detail = mysqli_fetch_array($execute)) {
?>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="./admin/uploads/<?php echo $fetch_product_detail['product_image'] ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="./admin/uploads/<?php echo $fetch_product_detail['product_image'] ?>" alt="IMG-PRODUCT">
						...
						<form action="shoping-cart.php" method="POST">
							...
							<div class="p-r-50 p-t-5 p-lr-0-lg">
								...
								<span class="mtext-106 cl2">
									RS-<?php echo $fetch_product_detail['product_price'] ?>
								</span>

								<br>

								<?php
								if ($fetch_product_detail['product_stock_quantity'] > 0) {
								?>
								...
								<p class="stext-102 cl3 p-t-23">
									<?php echo $fetch_product_detail['product_description'] ?>
								</p>
